...
)
{
    ...
    var numOfGamesSelected by remember { mutableStateOf("") }
    ...
    )
    {
        ...
        )
        {
            ...
            TextField(
                value = numOfGamesSelected,
                onValueChange = { numOfGamesSelected = it },
                modifier = Modifier
                    .padding(95.dp, 370.dp, 0.dp, 0.dp)
                    .width(200.dp),
                singleLine = true,
                keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number, imeAction = ImeAction.Go),
                label = { Text(stringResource(R.string.num_of_games)) }
            )
                ...
                Button(
                    onClick = {
                        if ((p1Name != "" || p2Name != "") && selectedButton != 0)
                        {
                            ...
                            gamePlay.setNumOfGames(numOfGamesSelected.toInt())
                            if (selectedButton == 0) gamePlay.setPlayerTurn(0)
                            else if (selectedButton == 1) gamePlay.setPlayerTurn(1)
                            else if (selectedButton == 2) gamePlay.setPlayerTurn(2)
                            onNextButtonClicked()
                        }
                              },
